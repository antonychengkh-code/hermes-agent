...
class TestOptionalEnvVarsRegistry:
    ...
    def test_lightpanda_token_registered(self):
        """LIGHTPANDA_TOKEN is listed in OPTIONAL_ENV_VARS."""
        from hermes_cli.config import OPTIONAL_ENV_VARS
        assert "LIGHTPANDA_TOKEN" in OPTIONAL_ENV_VARS


    def test_lightpanda_token_has_url(self):
        """LIGHTPANDA_TOKEN has a URL."""
        from hermes_cli.config import OPTIONAL_ENV_VARS
        assert OPTIONAL_ENV_VARS["LIGHTPANDA_TOKEN"]["url"] == "https://console.lightpanda.io/signup"
