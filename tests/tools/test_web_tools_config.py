...
class TestCheckWebApiKey:
    ...
    def test_null_backend_value_does_not_crash(self):
        ...
        # Hermetic: stub the lightpanda binary probe — a dev-box install is a
        # real zero-key backend and would legitimately flip this True.
        with patch("tools.web_tools._load_web_config", return_value={"backend": None}), \
             patch("plugins.web.lightpanda.provider.find_lightpanda_binary", return_value=None):
            from tools.web_tools import check_web_api_key
