...
| `LIGHTPANDA_TOKEN` | Optional Lightpanda Cloud API token for hosted JS-rendered web extraction. The local `lightpanda` binary works without it ([console.lightpanda.io](https://console.lightpanda.io/signup)) |
...
| `LIGHTPANDA_CLOUD_URL` | Override the Lightpanda Cloud region base URL (default `https://uswest.cloud.lightpanda.io`; e.g. `https://euwest.cloud.lightpanda.io`). |
