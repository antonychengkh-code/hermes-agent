...
```yaml
web:
  backend: firecrawl    # firecrawl | searxng | parallel | lightpanda | exa
  ...
  # Firecrawl/Keenable/Lightpanda free tiers. Set false to disable.
